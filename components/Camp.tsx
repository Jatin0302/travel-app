...
type CampProps = {
  ...
  title: string;
  subtitle: string;
  peoplesJoined: string;
};

const CampSite = ({ bgImage, title, subtitle, peoplesJoined }: CampProps) => {
  return (
    <>
      <div
      ...
      >
        <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
          ...
          <div className="flexCenter gap-6">
            ...
            <p className="bold-16 md:bold-20 text-white">{peoplesJoined}</p>
          </div>
        </div>
      </div>
    </>
